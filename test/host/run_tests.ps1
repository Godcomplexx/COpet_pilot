...
$suites = @{
    ...
    "test_assistant_mode" = @("modes\assistant_mode.c")
    "test_copet_speech"   = @("core\copet_speech.c")
    "test_assistant_ui"   = @("ui\assistant_ui.c", "ui\ui_canvas.c", "modes\assistant_mode.c")
}
